...
Current job: complete shared-tab lifecycle, including tabs without visible views, before measuring launch and memory. Run the `manage.py proof` tree on private Xvfb, including remote Cinnamon, while desktops are in use.
